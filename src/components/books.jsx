            ...
            <div className="row">
                ...
                <div className="col-lg-3 col-md-6 mb-4">
                    <div className="card">
                        ...
                        <div className="card-body">
                            <a href="https://books.google.com.ng/books/about/The_World_As_I_See_It.html?id=aNKOo94tO6cC&source=kp_cover&redir_esc=y"  target="_blank" rel="noreferrer">
                                <h3 className="card-title">
                ...
                <div className="col-lg-3 col-md-6 mb-4">
                    <div className="card">
                        ...
                        <div className="card-body">
                            <a href="https://www.damianibooks.com/en/products/6208784"  target="_blank" rel="noreferrer">
                                <h3 className="card-title">
